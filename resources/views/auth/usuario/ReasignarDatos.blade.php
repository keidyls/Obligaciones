    ...
    <table border="0" cellpadding="0" cellspacing="0" background="Images/fondos/bk-placa.jpg">
      ...
      <tr>
        <td height="30" align="center" valign="middle">
            ...
            <tr>
              <td width="700" align="center" valign="middle" class="titulo-pantalla">Reasignar Datos</td>
            </tr>
            <tr>
              <td><center><head>
...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0"> 
  <tr>
    <td align="center">
      <select name="seleccion" onchange=submit() class='input_text'>
            <option value="">Seleccione</option>
              <option value="1">Reasignar Clientes</option>
              <option value="2">Reasignar Obligaciones</option>
              <option value="3">Reasignar Obligaciones Programadas</option>
          </select>
    </td>
  </tr>
