    ...
    <table border="0" cellpadding="0" cellspacing="0" background="Images/fondos/bk-placa.jpg">
      ...
      <tr>
        <td height="30" align="center" valign="middle">
            ...
            <tr>
              <td width="700" align="center" valign="middle" class="titulo-pantalla">Crear Usuarios</td>
            </tr>
            <tr>
              <td><center><head>
...
<table width="700" border="0" cellpadding="0" cellspacing="0"background="Images/fondos/bk-body.jpg" align="center"> 
<tr>
  <td class="campos" align="right" width="150"><font color="#FF0000">*</font>Documento:&nbsp;&nbsp;</td>
  <td align="left" width="220"><input type="text" name="documento" maxlength="20" size="25" class='input_text' tabindex="1"></td>

  <td class="campos" align="right" width="150"><font color="#FF0000">*</font>Nombre:&nbsp;&nbsp;</td>
  <td align="left" width="220"><input type="text" id="nombre" name="nombre" maxlength="50" size="25" class='input_text' tabindex="2"></td>
</tr>
<tr>
...
<tr>
  <td class="campos" align="right" width="110"><font color="#FF0000">*</font>Apellidos:&nbsp;&nbsp;</td>
  <td align="left" width="220"><input type="text" id="apellidos" name="apellidos" maxlength="80" size="25" class='input_text' tabindex="3"></td>

  <td class="campos" align="right" width="150">Tel&eacute;fono:&nbsp;&nbsp;</td>
  <td align="left" width="220"><input type="text" id="telefono" name="telefono" maxlength="20" size="25" class='input_text' tabindex="4"></td>
</tr>
<tr>
  <td class="campos" align="right" width="110">&nbsp;</td>
  <td align="left" width="220">&nbsp;</td>
...
<tr>
  <td class="campos" align="right" width="110"><font color="#FF0000">*</font>E-mail:&nbsp;&nbsp;</td>
  <td align="left" width="220"><input type="text" id="email" name="email" MaxLength="150" size="25" class='input_text' tabindex="5"></td>

  <td class="campos" align="right" width="150"><font color="#FF0000">*</font>Usuario:&nbsp;&nbsp;</td>
  <td align="left" width="220"><input type="text" id="usuario" name="usuario" MaxLength="50" size="25" class='input_text' tabindex="6"></td>
</tr>
<tr>
  <td class="campos" align="right" width="110">&nbsp;</td>
  <td align="left" width="220">&nbsp;</td>
...
<tr>
  <td class="campos" align="right" width="150"><font color="#FF0000">*</font>Password:&nbsp;&nbsp;</td>
  <td align="left" width="220"><input type="password" id="password" name="password" MaxLength="50" size="25" class='input_text' tabindex="7"></td>

  <td class="campos" align="right" width="110"><font color="#FF0000">*</font>Re_Password:&nbsp;&nbsp;</td>
  <td align="left" width="220"><input type="password" id="repassword" name="repassword" MaxLength="50" size="25" class='input_text' tabindex="8"></td>
</tr>
<tr>
  <td class="campos" align="right" width="110">&nbsp;</td>
  <td align="left" width="220">&nbsp;</td>
...
<tr>
  ...
  <td align="left" width="220">
    <select name="perfil" class='input_text' tabindex="9">
       <option value=1>Administrador</option><option value=4>Asistente</option><option value=2>Director</option><option value=3>Lider</option><option value=5>RRHH</option>	    </select>
  </td>
  <td class="campos" align="right" width="110"><font color="#FF0000">*</font>Valido Hasta:&nbsp;&nbsp;</td>
  <td align="left" width="220"><input type="text" value="2020-01-23" name="theDate" class='input_text' tabindex="10">&nbsp;<img src="Images/images/calendario.png" alt="Calendario" width="24" height="24" title="Calendario" align="absmiddle" onClick="displayCalendar(document.forms[0].theDate,'yyyy-mm-dd',this)" tabindex="11"/></td>
</tr>
<tr>
  <td colspan="4" align="center"><div id='myform_errorloc' class='error_strings'></div></td>
</tr> 
<tr>
  <td class="campos" align="right" width="110">&nbsp;</td>
  <td align="left" width="220">&nbsp;</td>
...
<TR>
<TD colspan="6" align="center">
<input type="radio" name="comunicado" value="0" /> No comunicado
<input type="radio" name="comunicado" value="1" /> Comunicado
</TD>
</TR>

<tr>
  <td colspan="4" align="center"><br><input type="submit" value="Crear" name="enviar" tabindex="12"><br><br></td>
</tr>   
</table>
...
frmvalidator.addValidation("nombre","req","Por Favor Digite un Nombre");
frmvalidator.addValidation("nombre","maxlen=80","La longitud máxima para el nombre es de 80 caracteres");
frmvalidator.addValidation("nombre","alpha_s","Por favor digite solo letras y espacios en el nombre");

frmvalidator.addValidation("apellidos","req","Por Favor Digite los Apellidos");
frmvalidator.addValidation("apellidos","maxlen=80","La longitud máxima para el nombre es de 80 caracteres");  
frmvalidator.addValidation("apellidos","alpha_s","Por favor digite solo letras y espacios en el nombre");
                                                                      
frmvalidator.addValidation("email","req","Por favor digite su email");
frmvalidator.addValidation("email","maxlen=150","La longitud máxima para el Email es de 150 caracteres");
frmvalidator.addValidation("email","email","Por Favor Digite un email valido");

frmvalidator.addValidation("documento","maxlen=50","La longitud máxima para el documento son 50 caracteres");
frmvalidator.addValidation("documento","numeric","Por favor digite solo números en el documento");
frmvalidator.addValidation("documento","req","Por favor digite su número de documento");

frmvalidator.addValidation("usuario","maxlen=50","La longitud máxima para el Usuario es de 50 caracteres");
frmvalidator.addValidation("usuario","req","Por favor digite su usuario");
frmvalidator.addValidation("usuario","alnum","Por Favor Digite un usuario valido");

frmvalidator.addValidation("password","maxlen=50","La longitud máxima para el password es de 50 caracteres");
frmvalidator.addValidation("password","req","Por favor digite su password");
frmvalidator.addValidation("repassword","eqelmnt=password","Los Password digitados son Diferentes");
</script>

<table border="0" cellpadding="0" cellspacing="0">
  <tr>
<td style='padding: 3px; border-radius:5px;font-face:;color:white;font-size:14px'  bgcolor="#00007F"><b><center>&nbsp;documento&nbsp;</center></b></td>
<td style='padding: 3px; border-radius:5px;font-face:;color:white;font-size:14px'  bgcolor="#00007F"><b><center>&nbsp;nombre&nbsp;</center></b></td>
<td style='padding: 3px; border-radius:5px;font-face:;color:white;font-size:14px'  bgcolor="#00007F"><b><center>&nbsp;apellidos&nbsp;</center></b></td>
<td style='padding: 3px; border-radius:5px;font-face:;color:white;font-size:14px'  bgcolor="#00007F"><b><center>&nbsp;telefono&nbsp;</center></b></td>
<td style='padding: 3px; border-radius:5px;font-face:;color:white;font-size:14px'  bgcolor="#00007F"><b><center>&nbsp;email&nbsp;</center></b></td>
<td style='padding: 3px; border-radius:5px;font-face:;color:white;font-size:14px'  bgcolor="#00007F"><b><center>&nbsp;usuario&nbsp;</center></b></td>
<td style='padding: 3px; border-radius:5px;font-face:;color:white;font-size:14px'  bgcolor="#00007F"><b><center>&nbsp;fecha_ven&nbsp;</center></b></td>
  </tr><tr>
      <td style='padding: 3px; border-radius:5px;font-face:;font-size:12px'  bgcolor="D6D6D6">4</td>
      <td style='padding: 3px; border-radius:5px;font-face:;font-size:12px'  bgcolor="D6D6D6">D</td>
      <td style='padding: 3px; border-radius:5px;font-face:;font-size:12px'  bgcolor="D6D6D6">D</td>
      <td style='padding: 3px; border-radius:5px;font-face:;font-size:12px'  bgcolor="D6D6D6">4</td>
      <td style='padding: 3px; border-radius:5px;font-face:;font-size:12px'  bgcolor="D6D6D6">d@d.com</td>
      <td style='padding: 3px; border-radius:5px;font-face:;font-size:12px'  bgcolor="D6D6D6">D</td>
      <td style='padding: 3px; border-radius:5px;font-face:;font-size:12px'  bgcolor="D6D6D6">2019-06-12</td>
  </tr>
</table>
