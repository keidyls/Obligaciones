      ...
      <table border="0" cellpadding="0" cellspacing="0" background="Images/fondos/bk-placa.jpg">
        ...
        <tr>
          <td height="30" align="center" valign="middle">
              ...
              <tr>
                <td width="700" align="center" valign="middle" class="titulo-pantalla">Editar Costos y Tarifas Time Manager</td>
              </tr>
              <tr>
                <td><center><head>
...
<form action="control.php" method="Post" name="form1" id="form1">
  ...
  <tr>
    ...
    <td colspan="4" style="border-radius:10px" width="690" align="center" valign="middle" bgcolor="#000066" class="titulo-tabla">Editar Costos y Tarifas</td>          
  ...
  <tr>
				...
				<td class="campos">Secci&oacute;n:</td>

				<td colspan="2"><select class='input_text' name="suceso">
...
<tr>
    ...
    <td class="campos">&nbsp;Rango de Fechas de Cambio:</td>   

    <td> <input type="text" size="15" value="2020-01-23" name="theDate" class='input_text'><img width="24" height="24" align="absmiddle" onclick="displayCalendar(document.forms[0].theDate,'yyyy-mm-dd',this)" title="Calendario" alt="Calendario" src="Images/images/calendario.png"></td>
...
<tr>
     ...
     <td class="campos">&nbsp;Cliente (Requerido Solo para Tarifas Cliente): </td>
