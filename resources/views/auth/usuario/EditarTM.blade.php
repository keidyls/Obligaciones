      ...
      <table border="0" cellpadding="0" cellspacing="0" background="Images/fondos/bk-placa.jpg">
        ...
        <tr>
          <td height="30" align="center" valign="middle">
              ...
              <tr>
                <td width="700" align="center" valign="middle" class="titulo-pantalla">Editar Time Manager</td>
              </tr>
              <tr>
                <td><center><head>
...
<form action="control.php" method="Post" name="form1" id="form1">
  ...
  <tr>
    ...
    <td colspan="4" style="border-radius:10px" width="690" align="center" valign="middle" bgcolor="#000066" class="titulo-tabla">Busqueda de Registro de Tiempos</td>          
  ...
  <tr>
    ...
    <td class="campos">&nbsp;Rango de Busqueda:</td>   
