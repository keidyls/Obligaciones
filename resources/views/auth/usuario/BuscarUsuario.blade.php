    ...
    <table border="0" cellpadding="0" cellspacing="0" background="Images/fondos/bk-placa.jpg">
      ...
      <tr>
        <td height="30" align="center" valign="middle">
            ...
            <tr>
              <td width="700" align="center" valign="middle" class="titulo-pantalla">Buscar y Editar Usuarios</td>
            </tr>
            <tr>
...
<body>
  ...
  <form action="control.php" method="POST" name="form1" id="form1">
      <fieldset>
      <legend class="campos">Buscar Usuario</legend>
              <label for="state" class="campos">Nombre Apellidos o Documento:</label>

      <input type="text" name="state" id="state" size="25" class='input_text' tabindex="1"/>
      <script language="Javascript">
      
      var states = new Array("D D","C C","Jeyson Lombo","Eliana Avila","Steven Barrios","Natalia Piza","Bryan Suarez","Alex Gamboa","Marcela Gonzalez","Fredy Torres","Alejandro Paez","Andrea Cardenas","Sebastian Soche","Claudia Cucanchon","Raul Bayona","David Gelpud","Omar Contador","Nidia Guevara","Anyely Escarraga","Katherine Valencia","Sebastian Merchan","Sindy Salazar","Alejandra Nustes","Angelica Cruz","Monica Prieto","Diego Rey","Sonia Gualteros","Daniel Maldonado","Eduardo Gonzalez","Caren Bello","Maria de los angeles Pena","Lordis Mosquera","Viviana Martin","Natalia Gomez","Jhon pachon","William Macias","jennyfer Torres","Johanna Velasco","Isabel Avila","Mercedes Ramirez","Anderson Ortega","Gerencia Contable","Clara Mora","Jason Farfan","Tatiana Gonzalez","Christian Diaz","Jorge Onate","Diego Guzman","Alex Ballen","Eduwin Diaz","Yeimy Melo","Marjholy Garzon","Diego Morales","Ariel Valencia","Jenniffer Rodriguez","Daianna Uribe","Leidy Vargas","Hermes Valencia","Shirley Caballero","Carol Alarcon","Lorena Umbacia","Tatiana Delgadillo","Esteban Mora","Oscar Urrego","Samuel Moreno","Paola Munoz","Patricia Camargo","David Norato","Nancy Valbuena","Adriana Gonzalez","Anggie Rojas","Johana Castaneda","Juan Sanchez","Jeimy Millan","Jessica Jimenez","Janneth Moreno","Diana Romero","Tatiana Julio","Geraldine Castillo","Erika Bayona","Luz mery lara","MIGUEL MAHECHA","Cindy Pulido","Felipe Basto","Monica Contreras","Paola Vargas","Cristian Castro","Marcela Euse","Angel Roncancio","Auditoria Auditoria","Victor Rincon","Alejandro Velasquez","Diana Laverde","JULIETH FLOREZ","SIMON PEDRAZA","RICARDO GUZMAN","LIZETTE LORA","JULIAN PINZON","Johana Moreno","Olga Correa","Jorge Diaz","Ninibeth Hernandez","Lizeth Vanegas","Harold Cruz","Eliana Franco","Yeniffer Vega","Gina Lara","Dulfay Perez","Paola Gomez","JACQUELINE LEAL RANGEL","Jhonatan Prada","Yeimy Camargo","Marcela Quintero","Paulina Caicedo","Diana Navarro","Jenny Torres","Jimmy Espitia Ramirez","Leidy Galeano","javier Ramirez","Legales Legales","Pablo Matoma","Diana Judith Rodriguez Rincon","Johana Andrea Pena Baquero","Viviana Paola Ramirez Cepeda","Andrea Carolina Zambrano Nieto","Deissy  Martinez Torres","Adriana Carolina Santana Munevar","Libia Andrea Reina Velasco","Eduardo Zarama","Omar Bohorquez Rincon","Julieth Munoz","Ana Lucia Garcia","Luis Miguel garzon","Edilson Silva","Wilson Fernandez","Hastblade Largo Ramirez","Roger Angel","Carolina Borja","Jeisson Buitrago","Xiomara Andrea Benavides","Janneth Restrepo","Sandra Arias","Lady Alvarez","Diana Losada","Biviana Saenz","Cristian Ardila","Guillermo Celemin","Erika Rios","Diego Pena","Alba Luz Lopez","Vanessa Piza","Liliana Guaqueta","Paola Parra","Tatiana Bonett","Giovanny Piracoca","Yessica Vega","Milena Gonzalez","Mabel Lopez","Maite Araque","Jenny Suarez","Ricardo Gonzalez","Milena Guerrero linares","Jose Alfredo Moreno Forero","Eliminar Eliminar","Rodrigo Andres Quintero Gomez","Julian Duarte Sanchez");
      ...
      <br><br>
      <input type="submit" value="Buscar" name="enviar" tabindex="2">
      
      </fieldset>
  </form>
<script language="JavaScript" type="text/javascript">
var frmvalidator  = new Validator("form1");
frmvalidator.addValidation("state","alnum_s","Por favor digite solo letras o n�meros para realizar la b�squeda");
</script>
<br>
</body></center></td>
            </tr>
