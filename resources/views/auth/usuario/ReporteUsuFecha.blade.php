      ...
      <table border="0" cellpadding="0" cellspacing="0" background="Images/fondos/bk-placa.jpg">
        ...
        <tr>
          <td height="30" align="center" valign="middle">
              ...
              <tr>
                <td width="700" align="center" valign="middle" class="titulo-pantalla">Reporte Usuario Fecha Time Manager</td>
              </tr>
              <tr>
...
<br>
<br>
<form action="control.php" method="get" name="form1" id="form1">
...
<TD colspan="2" align="center">&nbsp;<a href="Vista/reportusufechaxls.php?grabar=1&theDate=&theDate1=&todos=&wcomplemento=" target="_blank"><img src="Images/images/excel.jpg" height="35"></center></a></TD>
...
<TD colspan="2" align="center">&nbsp;Fecha Inicio del informe:<input type="text" value="2020-01-23" name="theDate"><input type="button" value="Cal" onclick="displayCalendar(document.forms[0].theDate,'yyyy-mm-dd',this)"></td>
...
<TD colspan="2" align="center">&nbsp;Fecha Fin:<input type="text" value="2020-01-23" name="theDate1"><input type="button" value="Cal" onclick="displayCalendar(document.forms[0].theDate1,'yyyy-mm-dd',this)"></td>
 ...
 <tr>
    ...
    <tr>
      ...
      <td colspan="4" style="border-radius:10px" align="center" valign="middle" bgcolor="#000066" class="titulo-tabla">Usuarios</td>

    </tr>  

    <tr><td align=center style='width:5px'><input name="todos" type=checkbox value="1" ></td><td align=left><b>Todos</b></td>

    <tr><td align=center style='width:5px'><input name=usu128 type=checkbox value=128  ></td><td align=left><b>Ballen Alex</b></td><tr><td align=center style='width:5px'><input name=usu87 type=checkbox value=87  ></td><td align=left><b>Auditoria Auditoria</b></td><tr><td align=center style='width:5px'><input name=usu175 type=checkbox value=175  ></td><td align=left><b>C C</b></td><tr><td align=center style='width:5px'><input name=usu163 type=checkbox value=163  ></td><td align=left><b>Cucanchon Claudia</b></td><tr><td align=center style='width:5px'><input name=usu176 type=checkbox value=176  ></td><td align=left><b>D D</b></td><tr><td align=center style='width:5px'><input name=usu109 type=checkbox value=109  ></td><td align=left><b>Norato David</b></td><tr><td align=center style='width:5px'><input name=usu124 type=checkbox value=124  ></td><td align=left><b>Morales Diego</b></td><tr><td align=center style='width:5px'><input name=usu114 type=checkbox value=114  ></td><td align=left><b>Mora Esteban</b></td><tr><td align=center style='width:5px'><input name=usu21 type=checkbox value=21  ></td><td align=left><b>Piracoca Giovanny</b></td><tr><td align=center style='width:5px'><input name=usu101 type=checkbox value=101  ></td><td align=left><b>Moreno Janneth</b></td><tr><td align=center style='width:5px'><input name=usu58 type=checkbox value=58  ></td><td align=left><b>Ramirez javier</b></td><tr><td align=center style='width:5px'><input name=usu174 type=checkbox value=174  ></td><td align=left><b>Lombo Jeyson</b></td><tr><td align=center style='width:5px'><input name=usu13 type=checkbox value=13  ></td><td align=left><b>Moreno Forero Jose Alfredo</b></td><tr><td align=center style='width:5px'><input name=usu2 type=checkbox value=2  ></td><td align=left><b>Duarte Sanchez Julian</b></td><tr><td align=center style='width:5px'><input name=usu57 type=checkbox value=57  ></td><td align=left><b>Legales Legales</b></td><tr><td align=center style='width:5px'><input name=usu80 type=checkbox value=80  ></td><td align=left><b>LORA LIZETTE</b></td><tr><td align=center style='width:5px'><input name=usu116 type=checkbox value=116  ></td><td align=left><b>Umbacia Lorena</b></td><tr><td align=center style='width:5px'><input name=usu137 type=checkbox value=137  ></td><td align=left><b>Ramirez Mercedes</b></td><tr><td align=center style='width:5px'><input name=usu19 type=checkbox value=19  ></td><td align=left><b>Gonzalez Milena</b></td><tr><td align=center style='width:5px'><input name=usu171 type=checkbox value=171  ></td><td align=left><b>Piza Natalia</b></td><tr><td align=center style='width:5px'><input name=usu82 type=checkbox value=82  ></td><td align=left><b>PEDRAZA SIMON</b></td><tr><td align=center style='width:5px'><input name=usu25 type=checkbox value=25  ></td><td align=left><b>Piza Vanessa</b></td>
      </td>
...
<TD colspan="2" align="center"><input type="submit" value="Consultar" name="enviar"></TD>
