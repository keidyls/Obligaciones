      ...
      <table border="0" cellpadding="0" cellspacing="0" background="Images/fondos/bk-placa.jpg">
        ...
        <tr>
          <td height="30" align="center" valign="middle">
              ...
              <tr>
                <td width="700" align="center" valign="middle" class="titulo-pantalla">Costo Usuario</td>
              </tr>
              <tr>
                <td><center><head>
...
<form action="control.php" method="post" name="form1" id="form1">
  ...
  <tr>
    ...
    <td colspan="4" style="border-radius:10px" width="690" align="center" valign="middle" bgcolor="#000066" class="titulo-tabla">Costos Usuarios</td>          
  ...
  <tr>
    ...
    <tr>
     ...
     <td class="campos">&nbsp;Usuario: </td>
        ...
        <td colspan="3">
          ...
          <select class='input_text' name="idusuario">

          <option value=128>Alex-Ballen</option><option value=87>Auditoria-Auditoria</option><option value=175>C-C</option><option value=163>Claudia-Cucanchon</option><option value=176>D-D</option><option value=109>David-Norato</option><option value=124>Diego-Morales</option><option value=114>Esteban-Mora</option><option value=21>Giovanny-Piracoca</option><option value=101>Janneth-Moreno</option><option value=58>javier-Ramirez</option><option value=174>Jeyson-Lombo</option><option value=13>Jose Alfredo-Moreno Forero</option><option value=2>Julian-Duarte Sanchez</option><option value=57>Legales-Legales</option><option value=80>LIZETTE-LORA</option><option value=116>Lorena-Umbacia</option><option value=137>Mercedes-Ramirez</option><option value=19>Milena-Gonzalez</option><option value=171>Natalia-Piza</option><option value=82>SIMON-PEDRAZA</option><option value=25>Vanessa-Piza</option>
          </select>
    ...
    <td class="campos">&nbsp;Costo:</td>

    <td><input type="text" id="Costo" name="Costo" maxlength="10" class='input_text'></td>

    <td class="campos">&nbsp;Capacidad en Horas: </td>

    <td><input type="text" id="Capacidad_Horas" name="Capacidad_Horas" maxlength="10" class='input_text'></td>
  ...
  <tr>
    ...
    <td class="campos" align="right" width="150"><font color="#FF0000">*</font>Perfil:&nbsp;&nbsp;</td>

    <td align="left" width="220">

      <select name="perfil" class='input_text' tabindex="9">

	     <option value=1>Junior</option><option value=2>Senior</option><option value=3>Director</option><option value=4>Socio</option>
	    </select>
...
//You should create the validator only after the definition of the HTML form
  ...
  frmvalidator.addValidation("Costo","req","Falta costo");

  frmvalidator.addValidation("Capacidad_Horas","req","Falta capacidad");
...
<table border="0" cellpadding="0" cellspacing="0">
	<tr>
<td style='padding: 3px; padding: 3px; border-radius:5px' bgcolor="#00007F"><b><center><font face="" color="ffffff" size="1">&nbsp;idcosto_usuario&nbsp;</font></center></b></td>
<td style='padding: 3px; padding: 3px; border-radius:5px' bgcolor="#00007F"><b><center><font face="" color="ffffff" size="1">&nbsp;idusuario&nbsp;</font></center></b></td>
...
<td style='padding: 3px; padding: 3px; border-radius:5px' bgcolor="#00007F"><b><center><font face="" color="ffffff" size="1">&nbsp;costo&nbsp;</font></center></b></td>
<td style='padding: 3px; padding: 3px; border-radius:5px' bgcolor="#00007F"><b><center><font face="" color="ffffff" size="1">&nbsp;perfil&nbsp;</font></center></b></td>
<td style='padding: 3px; padding: 3px; border-radius:5px' bgcolor="#00007F"><b><center><font face="" color="ffffff" size="1">&nbsp;capacidad&nbsp;</font></center></b></td>
<td style='padding: 3px; padding: 3px; border-radius:5px' bgcolor="#00007F"><b><center><font face="" color="ffffff" size="1">&nbsp;Borrar&nbsp;</font></center></b></td>
		...
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">166</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">Alejandro</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">2290965</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">1</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">162</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><font face="" size="1"><a href="control.php?opcion=38&idcosto_usuario=12&grabar=4" onclick="borrar()"><center><img src="Images/images/borrar.png" border="0" height="27" alt="Borrar"></center></a></font></td>
	</tr>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">13</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">139</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">Johanna</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">2563532</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">1</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">162</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><font face="" size="1"><a href="control.php?opcion=38&idcosto_usuario=13&grabar=4" onclick="borrar()"><center><img src="Images/images/borrar.png" border="0" height="27" alt="Borrar"></center></a></font></td>
	</tr>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">14</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">155</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">Sindy</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">2563532</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">1</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">162</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><font face="" size="1"><a href="control.php?opcion=38&idcosto_usuario=14&grabar=4" onclick="borrar()"><center><img src="Images/images/borrar.png" border="0" height="27" alt="Borrar"></center></a></font></td>
	</tr>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">15</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">134</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">Clara</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">2776813</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">1</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">162</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><font face="" size="1"><a href="control.php?opcion=38&idcosto_usuario=15&grabar=4" onclick="borrar()"><center><img src="Images/images/borrar.png" border="0" height="27" alt="Borrar"></center></a></font></td>
	</tr>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">16</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">163</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">Claudia</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">3978504</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">2</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">162</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><font face="" size="1"><a href="control.php?opcion=38&idcosto_usuario=16&grabar=4" onclick="borrar()"><center><img src="Images/images/borrar.png" border="0" height="27" alt="Borrar"></center></a></font></td>
	</tr>
		...
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">Giovanny</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">3978504</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">2</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">162</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><font face="" size="1"><a href="control.php?opcion=38&idcosto_usuario=17&grabar=4" onclick="borrar()"><center><img src="Images/images/borrar.png" border="0" height="27" alt="Borrar"></center></a></font></td>
	</tr>
		...
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">javier</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">4202538</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">2</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">162</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><font face="" size="1"><a href="control.php?opcion=38&idcosto_usuario=18&grabar=4" onclick="borrar()"><center><img src="Images/images/borrar.png" border="0" height="27" alt="Borrar"></center></a></font></td>
	</tr>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">19</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">143</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">Natalia</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">7295624</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">3</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">162</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><font face="" size="1"><a href="control.php?opcion=38&idcosto_usuario=19&grabar=4" onclick="borrar()"><center><img src="Images/images/borrar.png" border="0" height="27" alt="Borrar"></center></a></font></td>
	</tr>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">20</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">109</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">David</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">3059392</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">2</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><center><font face="" size="1">162</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="whitesmoke"><font face="" size="1"><a href="control.php?opcion=38&idcosto_usuario=20&grabar=4" onclick="borrar()"><center><img src="Images/images/borrar.png" border="0" height="27" alt="Borrar"></center></a></font></td>
	</tr>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">21</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">2</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">Julian</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">5432111</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">2</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><center><font face="" size="1">162</font></center></td>
		<td style='padding: 3px; border-radius:5px' bgcolor="D6D6D6"><font face="" size="1"><a href="control.php?opcion=38&idcosto_usuario=21&grabar=4" onclick="borrar()"><center><img src="Images/images/borrar.png" border="0" height="27" alt="Borrar"></center></a></font></td>
	</tr>
</table>
